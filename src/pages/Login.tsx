      ...
      <main className="p-6 sm:px-[5%] py-10 gap-5 bg-background min-h-screen flex items-center justify-center flex-col text-text-primary w-full max-w-screen-2xl">
        {userInfo ? (
          <div className="bg-surface p-5 sm:p-8 rounded-lg flex flex-col items-center gap-3">
            ...
            <button className="text-md cursor-pointer font-semibold text-primary-txt  bg-primary px-4 py-2 rounded-lg hover:bg-primary-hover transition" onClick={logoutUser}>
              Logout
            </button>
          </div>
        ) : (
